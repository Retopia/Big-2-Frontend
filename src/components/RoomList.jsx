      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <div className="flex space-x-4 mt-1 text-sm text-gray-300">
            <p>Players: <span className="font-medium">{players.length}/4</span></p>
        ...
        <button
          ...
          disabled={status === "playing" || players.length >= 4}
          className={`px-4 py-2 rounded text-sm font-medium ${status === "playing" || players.length >= 4
